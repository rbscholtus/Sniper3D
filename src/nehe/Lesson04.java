 ...
 */
public class Lesson04 implements GLEventListener, KeyListener {
    ...
    public static void main(String[] args) {
        ...
        new Lesson04(fullscreen);
    }

    /**
     * Creates an animated GLWindow.
     */
    public Lesson04(boolean fullscreen) {
        ...
        window.setTitle("NeHe Lesson 04: Rotation");
        if (fullscreen) {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // Reset The Current Modelview Matrix ( NEW )
        gl.glLoadIdentity();

        // Move Right 1.5 Units And Into The Screen 6.0 ( NEW )
        gl.glTranslatef(1.5f, 0.0f, -6.0f);
